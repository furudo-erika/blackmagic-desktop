...
/**
 * EmployeeFace — circular headshot avatar for AI employees (formerly
 * called "agents"). Pulls a deterministic face from pravatar.cc using
 * the agent's `face_seed:` frontmatter (falls back to slug). Falls back
 * to a tinted initial-monogram if the network image fails or is
 * disabled.
 */
