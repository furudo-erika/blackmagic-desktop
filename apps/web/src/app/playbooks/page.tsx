...
const GROUPS: Array<{ id: string; label: string; description: string; color: string }> = [
  { id: 'gtm-starter', label: 'GTM starter pack', description: 'Visitor ID, signal-based outbound, lead qualification, ICP tuning, demand-gen briefs, sales research, RevOps pipeline health.', color: '#E8523A' },
