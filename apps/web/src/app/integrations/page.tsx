...
const BRAND_FALLBACK_PATHS: Record<IntegrationProvider, string> = {
  ...
  pipedrive:
    'M14.4 5.4c0-2.4-1.8-4.2-4.5-4.2-2.4 0-4.2 1.2-5.1 3l3 1.5c.3-.9 1.2-1.5 2.1-1.5 1.2 0 2.1.9 2.1 1.8 0 1.2-.9 1.8-2.1 1.8H7.5v3h2.4c1.5 0 2.7 1.2 2.7 2.7 0 1.5-1.2 2.7-2.7 2.7-1.5 0-2.4-.9-2.7-2.1L4.2 15c.6 2.4 2.7 4.2 5.7 4.2 3.3 0 6-2.4 6-5.7 0-2.1-1.2-3.6-2.7-4.2 1.2-.9 1.8-2.1 1.8-3.9z',
  gong:
...
export default function IntegrationsPage() {
  ...
  return (
    <PageShell>
      <PageHeader
        title="Integrations"
        subtitle="Paste API keys for the services your agents should read / write — CRMs, messaging, email providers, scrapers. BYOK, local-only: keys live in .bm/integrations.json and mirror to <context>/.env."
        icon={Plug}
      />
