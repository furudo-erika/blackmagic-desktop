...
<p>${body}</p>
  ...
  app.get('/api/config/integration-keys', (c) =>
    c.json({
      ...
      salesforce_access_token: Boolean(config.salesforce_access_token),
      salesforce_instance_url: Boolean(config.salesforce_instance_url),
      pipedrive_api_key: Boolean(config.pipedrive_api_key),
      pipedrive_domain: Boolean(config.pipedrive_domain),
      feishu_app_id: Boolean(config.feishu_app_id),
      feishu_app_secret: Boolean(config.feishu_app_secret),
      feishu_webhook_url: Boolean(config.feishu_webhook_url),
      metabase_site_url: Boolean(config.metabase_site_url),
      metabase_api_key: Boolean(config.metabase_api_key),
      supabase_url: Boolean(config.supabase_url),
      supabase_service_role_key: Boolean(config.supabase_service_role_key),
