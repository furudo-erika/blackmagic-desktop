...
Local-first AI GTM engineer. Your context lives in `~/BlackMagic/` as plain markdown. The app drives Codex models (gpt-5.3-codex) via zenn.engineering to read, edit, and extend that context.
...
doc/
  ...
  CONTEXT.md          Context directory layout + frontmatter conventions
